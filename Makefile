...
pkgdatadir = $(datadir)/QUARcore
pkgincludedir = $(includedir)/QUARcore
pkglibdir = $(libdir)/QUARcore
pkglibexecdir = $(libexecdir)/QUARcore
...
CONFIG_HEADER = $(top_builddir)/src/config/QUAR-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/QUAR-config.h.in \
...
ACLOCAL = ${SHELL} /home/william/Desktop/QUAR-core/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/william/Desktop/QUAR-core/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/william/Desktop/QUAR-core/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/william/Desktop/QUAR-core/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = QUAR-cli
BITCOIN_DAEMON_NAME = QUARd
BITCOIN_GUI_NAME = QUAR-qt
BITCOIN_TX_NAME = QUAR-tx
...
COPYRIGHT_HOLDERS_FINAL = The QUAR Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = QUAR Core
COPYRIGHT_YEAR = 2018
CPP = gcc -E
CPPFILT = /usr/bin/c++filt
CPPFLAGS = -I/include/ -DHAVE_BUILD_INFO -D__STDC_FORMAT_MACROS
CRYPTO_CFLAGS = 
CRYPTO_LIBS = -lcrypto
CXX = g++ -std=c++11
CXXCPP = g++ -std=c++11 -E
...
MAINT = 
MAKEINFO = ${SHELL} /home/william/Desktop/QUAR-core/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = QUARcore
PACKAGE_BUGREPORT = https://github.com/NicholasAdmin/QUAR/issues
PACKAGE_NAME = QUAR Core
PACKAGE_STRING = QUAR Core 1.0.3
PACKAGE_TARNAME = QUARcore
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/william/Desktop/QUAR-core
abs_srcdir = /home/william/Desktop/QUAR-core
abs_top_builddir = /home/william/Desktop/QUAR-core
abs_top_srcdir = /home/william/Desktop/QUAR-core
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/william/Desktop/QUAR-core/build-aux/install-sh
...
BITCOIND_BIN = $(top_builddir)/src/QUARd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/QUAR-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/QUAR-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = QUAR-Qt.app
OSX_DMG = QUAR-Core.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_QUAR_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_QUAR_coverage.info test_QUAR.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/QUAR-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/QUAR-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/QUAR-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/QUAR-config.h
$(top_srcdir)/src/config/QUAR-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/QUAR-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/QUAR-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/QUAR-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "QUAR-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/QUAR-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_QUAR.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_QUAR -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_QUAR_filtered.info: test_QUAR.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_QUAR_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_QUAR_filtered.info
...
#test_QUAR_coverage.info: baseline_filtered_combined.info test_QUAR_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_QUAR_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_QUAR_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_QUAR_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_QUAR.coverage/.dirstamp:  test_QUAR_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_QUAR.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf coverage_percent.txt test_QUAR.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
